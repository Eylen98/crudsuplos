...
<html>
    <head>
    <link rel="shortcut icon" href="/crudsuplos/logo.png" />
    <meta charset="utf-8">
    ...
    <body>
    <header>
        <h2 class="text-center text-dark"><span class="badge badge-success">Suplos</span></h2>
    </header>    
        ...
        <div class="container">                
            <div class="row">       
                ...
                <div class="col text-right">                        
                    <h5>Total Productos: <span class="badge badge-success">{{totalStock}}</span></h5>
                </div>    
            </div>                
            <div class="row mt-5">
                <div class="col-lg-12">                    
                        ...
                        <tbody>
                            <tr v-for="(movil,indice) of moviles">                                
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <!-- <button class="btn btn-success" title="Export" @click="btnExport(movil.id)"><span class="glyphicon glyphicon-print>"><i class="fas fa-trash-alt"></i></span>Exportar Excel</button>      -->
								</div>
                                </td>
                            </tr>    
                        </tbody>
